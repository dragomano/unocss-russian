...
`order-attributify` задаёт порядок элементов в режиме атрибутов. Он не сортирует утилиты внутри их значений, например `un-before="text-center font-sans color-gray"`.
