...
Рантайм не включает в себя префлайты. Если вам нужен сброс стилей, вы можете добавить свой собственный или воспользоваться одним из вариантов из [пакета Reset](/guide/style-reset).
