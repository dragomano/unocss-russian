---
title: Пакеты
description: "Пакеты UnoCSS: доступные пакеты, а также те, что включены и активированы в UnoCSS."
outline: deep
---

# Пакеты {#packages}

UnoCSS — это монорепозиторий, содержащий несколько пакетов. На этой странице перечислены все пакеты и указано, какие из них включены в пакет `unocss`:

| Пакет                                                                | Описание                                          | Включен в `unocss`  | Активирован  |
| -------------------------------------------------------------------- | ------------------------------------------------- | ------------------- | ------------ |
...
| [@unocss/processor-lightningcss](/processors/lightningcss)           | Обрабатывает сгенерированный CSS с помощью Lightning CSS | Нет          | Нет          |
